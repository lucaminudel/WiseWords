...
- these WiseWords.FrontEnd file
  - the code loading the environment configuration info [here](./WiseWords.FrontEnd/src/config/environment.ts)
...
- in the FrontEnd code
   - the auth callback page page [here](./WiseWords.FrontEnd/src/components/CallbackPage.tsx)
